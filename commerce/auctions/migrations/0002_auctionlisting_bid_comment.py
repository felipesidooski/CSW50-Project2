# Generated by Django 5.1.2 on 2024-10-09 00:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('starting_bid', models.DecimalField(decimal_places=2, help_text='Valor em dólares (USD).', max_digits=10)),
                ('image_url', models.URLField(blank=True, null=True)),
                ('category', models.CharField(blank=True, choices=[('wand', 'Wand'), ('cauldron', 'Cauldron'), ('cloak', 'Cloak'), ('action_figure', 'Action Figure'), ('funko_pop', 'Funko Pop'), ('rare_item', 'Rare Item')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bid_amount', models.DecimalField(decimal_places=2, help_text='Valor em dólares (USD).', max_digits=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
